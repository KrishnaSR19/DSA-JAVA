...
/*
 * Optimal
 * Time Complexity: O(N * log(M)), where N is the number of piles and M
 * is the maximum number of bananas in a pile. The binary search runs log(M) times, and the for loop runs N times.
 * Space Complexity: O(1), as no extra space is used.
 * 
 */
